...
int estadoColor = 0; // 0 = rojo, 1 = verde, 2 = azul
...
void fondoCiclo()
{
	...
	if (elapsed >= 2) // cada 2 segundos
	{
		...
		if (estadoColor == 0) { rojo = 1.0f; verde = 0.0f; azul = 0.0f; } // rojo
		else if (estadoColor == 1) { rojo = 0.0f; verde = 1.0f; azul = 0.0f; } // verde
		else if (estadoColor == 2) { rojo = 0.0f; verde = 0.0f; azul = 1.0f; } // azul
