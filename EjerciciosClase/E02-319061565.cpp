...
void CrearLetrasyFiguras()
{
	...
	GLfloat vertices_trianguloAzul[] = { //3
		//X			Y			Z			R		G		B
		-1.0f,	-1.0f,		0.5f,			0.0f,	0.0f,	1.0f,
		1.0f,	-1.0f,		0.5f,			0.0f,	0.0f,	1.0f,
	...
	GLfloat vertices_cuadradoRojo[] = { //4
		//X			Y			Z			R		G		B
	...
	GLfloat vertices_trianguloVerde[] = { //5
		//X			Y			Z			R		G		B
...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(0.75f, 0.3f, 1.0f));
		...
		// VENTANA VERDE IZQ
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.275f, 0.0f, -1.0f));
		model = glm::scale(model, glm::vec3(0.325f, 0.45f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		glUniformMatrix4fv(uniformProjection, 1, GL_FALSE, glm::value_ptr(projection));
		...
		// ARBOL IZQ
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.8f, -0.5f, -1.0f));
		...
		// TRONCO DER
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.8f, -0.9f, -1.0f));
