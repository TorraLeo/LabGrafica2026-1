...
void Window::ManejaTeclado(GLFWwindow* window, int key, int code, int action, int mode)
{
	...
	// ------------------------ ESTAS SI SE LIMITAN POR LA NATURALEZA DEL PERRO XD------------------------
	// PATA DEL DER 
	if (key == GLFW_KEY_1)
	{
		theWindow->articulacion1 += 10.0;
		// Se asegura de que el ángulo no exceda los 45 grados
	...
	else if (key == GLFW_KEY_4) // REGRESA A POS ORIGINAL
	{
		theWindow->articulacion2 -= 10.0;
		if (theWindow->articulacion2 < 0.0)
		{
			theWindow->articulacion2 = 0.0;
		}
	}
