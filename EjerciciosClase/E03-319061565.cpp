...
int main()
{
	...
	*/
	...
	while (!mainWindow.getShouldClose())
	{
		...
		model = glm::scale(model, glm::vec3(5.0f,0.005f,5.0f));
		...
		color = glm::vec3(0.224f, 0.239f, 0.259f);
		...
		model = glm::scale(model, glm::vec3(2.51f, 0.8f, 0.8f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// VENTANAS FRONTALES 1
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.5f, 2.0f, -3.99f));
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 2.51f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		// PUERTA
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.4075f, -3.99f));
		model = glm::scale(model, glm::vec3(0.8f, 0.8f, 2.51f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotax()), glm::vec3(1.0f, 0.0f, 0.0f));
		model = glm::rotate(model, glm::radians(mainWindow.getrotay()), glm::vec3(0.0f, 1.0f, 0.0f));  //al presionar la tecla Y se rota sobre el eje y
		model = glm::rotate(model, glm::radians(mainWindow.getrotaz()), glm::vec3(0.0f, 0.0f, 1.0f));
		...
		// TRONCO IZQ
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-2.0f, 0.25f, -4.0f));
		...
		// VENTANA APLASTADA
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 1.5f, -5.25f));
